...
export default function HomePage({ hoteles, cafes, kayak, cicloturismo, senderismo }) {
  return (
    <div>
      <Header />
      <Eldorado />
      <div className="flex items-center justify-center h-screen bg-gray-100 my-10">
        <Link href="https://exp-oeldorado-im57.vercel.app/">
      ...
      <LinksAdicionales>
        ...
        <div className='imgCont'>
          <img src='https://res.cloudinary.com/dzqdjsrez/image/upload/v1688422550/agenda-next-panel/inyrov7cesjdunjm5dme.jpg' alt="Additional Image" />
        </div>
      </LinksAdicionales>
